...
public class UsersBackItem implements Parcelable {
    ...
    public UsersBackItem() {
    }

    protected UsersBackItem(Parcel in) {
    ...
    public static final Creator<UsersBackItem> CREATOR = new Creator<UsersBackItem>() {
        @Override
        public UsersBackItem createFromParcel(Parcel source) {
            return new UsersBackItem(source);
        }

        @Override
        public UsersBackItem[] newArray(int size) {
            return new UsersBackItem[size];
        }
    };
}